...
This is the correct approach for financial or inventory state stored in a relational database. See [BEE-161](161.md) for isolation levels and [BEE-245](245.md) for optimistic vs. pessimistic strategies.
...
- [BEE-161](161.md) -- Isolation levels: how databases prevent race conditions at the storage layer
