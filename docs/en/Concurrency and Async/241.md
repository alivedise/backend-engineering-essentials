...
# [BEP-241] Race Conditions and Data Races
...
This is the correct approach for financial or inventory state stored in a relational database. See [BEP-161](../Transactions%20and%20Isolation/161.md) for isolation levels and [BEP-245](245.md) for optimistic vs. pessimistic strategies.
...
- [BEP-240](240.md) -- Concurrency models: threads, goroutines, async/await
- [BEP-241](241.md) -- Locks and synchronization primitives
- [BEP-245](245.md) -- Optimistic vs. pessimistic concurrency control
- [BEP-161](../Transactions%20and%20Isolation/161.md) -- Isolation levels: how databases prevent race conditions at the storage layer
