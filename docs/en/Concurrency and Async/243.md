...
│           └── Yes → use connection pooling (see [BEE-30](30.md)1)
└── No, mostly CPU-bound?
...
- [BEE-240](240.md) — Threads vs Processes vs Coroutines: the concurrency primitives underlying async runtimes
- [BEE-241](241.md) — Worker Pools: offloading CPU-bound work from the event loop
- [BEE-301](301.md) — Connection Pooling: preventing connection exhaustion in async services
