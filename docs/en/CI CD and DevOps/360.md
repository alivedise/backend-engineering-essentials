...
# [BEP-360] Continuous Integration Principles
...
- **BEP-340** — Testing strategy and how tests integrate into the CI pipeline
- **BEP-361** — Deployment strategies that consume CI-produced artifacts
- **BEP-365** — CI/CD pipeline design and infrastructure
