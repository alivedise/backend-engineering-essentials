...
- **BEE-340** — Testing strategy and how tests integrate into the CI pipeline
- **BEE-361** — Deployment strategies that consume CI-produced artifacts
- **BEE-365** — CI/CD pipeline design and infrastructure
