...
# [BEP-362] Infrastructure as Code
...
See [BEP-32: Secrets Management](#) for the full secrets handling policy.
...
In CI/CD for IaC, the plan step is mandatory and its output is attached to the pull request for reviewer inspection. Apply only runs after the plan has been reviewed and the PR approved. See [BEP-360: CI for IaC](#) for the pipeline pattern.
...
- [BEP-32: Secrets Management](#) — Secrets store patterns, rotation, and injection at runtime
- [BEP-360: CI for IaC](#) — Pipeline structure: lint, plan, policy check, apply gates
- [BEP-361: Deployment Strategies](#) — How immutable infrastructure enables blue-green and canary deployments
