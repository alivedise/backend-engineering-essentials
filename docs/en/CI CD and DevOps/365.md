...
- **BEE-340** — Testing strategy; which test types belong in which pipeline stage
- **BEE-360** — CI principles; the upstream practices that make pipeline design work
- **BEE-361** — Deployment strategies; what happens after the pipeline promotes an artifact
- **BEE-364** — Container as artifact; how images are built, tagged, and stored
