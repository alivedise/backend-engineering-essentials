...
- [BEE-340](340.md) — Testing strategy; which test types belong in which pipeline stage
- [BEE-360](360.md) — CI principles; the upstream practices that make pipeline design work
- [BEE-361](361.md) — Deployment strategies; what happens after the pipeline promotes an artifact
- [BEE-364](364.md) — Container as artifact; how images are built, tagged, and stored
