...
- **BEP-340** — Testing strategy; which test types belong in which pipeline stage
- **BEP-360** — CI principles; the upstream practices that make pipeline design work
- **BEP-361** — Deployment strategies; what happens after the pipeline promotes an artifact
- **BEP-364** — Container as artifact; how images are built, tagged, and stored
