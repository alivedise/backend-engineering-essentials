...
:::info
BEP (Backend Engineering Principles) is a collection of vendor-agnostic guidelines and best practices for backend engineering.
:::

## Context

Backend engineering spans a vast landscape -- from authentication and networking to distributed systems and observability. Engineers often learn these concepts piecemeal, through scattered blog posts, tribal knowledge, or painful production incidents. BEP provides a structured, numbered set of principles that build a coherent mental model of backend engineering.
...
Each BEP follows a consistent structure:
...
|-------|----------|-------|
| 0-9 | BEP Overall | Purpose, glossary, meta |
...
- [ADP](https://alivedise.github.io/api-design-principle-beta/) -- API Design Principles (deep dive on API design)
- [DDP](https://alivedise.github.io/database-design-principles/) -- Database Design Principles (deep dive on database design)

## Related BEPs

- [BEP-1](1.md) How to Read BEP
- [BEP-5](5.md) Glossary
