...
Columns that appear in `WHERE`, `JOIN ON`, and `ORDER BY` clauses are candidates for indexing. See [BEE-6002](indexing-deep-dive.md) for indexing strategy.
...
- [BEE-6002](indexing-deep-dive.md) — Database Indexing Strategies: which columns to index and how
- [BEE-13002](../performance-scalability/horizontal-vs-vertical-scaling.md) — Resource Management: connection lifecycle and cleanup patterns
- [BEE-13004](../performance-scalability/profiling-and-bottleneck-identification.md) — Profiling and Observability: detecting slow queries and N+1 in production
