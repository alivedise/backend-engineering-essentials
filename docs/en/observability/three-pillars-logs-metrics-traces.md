...
Unstructured log lines cannot be searched by field or aggregated. When an incident occurs, you cannot filter `level=error AND service=order-service AND trace_id=X`. You are reduced to grepping free text at 2 AM. Always log in JSON or a structured format. See [BEE-14002](structured-logging.md).
...
- [BEE-14002](structured-logging.md) — Structured logging: schema, log levels, and what not to log
- [BEE-14003](distributed-tracing.md) — Distributed tracing: spans, sampling strategies, and context propagation
- [BEE-14004](alerting-philosophy.md) — Alerting philosophy: what to alert on and how to write good runbooks
- [BEE-14005](slos-and-error-budgets.md) — SLOs and error budgets: using metrics to define and track reliability targets
