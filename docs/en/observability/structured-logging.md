...
- [BEE-14001](three-pillars-logs-metrics-traces.md) — The three pillars: how logs, metrics, and traces complement each other
- [BEE-14002](structured-logging.md) — Distributed tracing: `trace_id` and `span_id` in the context of distributed systems
- [BEE-4006](../api-design/api-error-handling-and-problem-details.md) — Error handling: including correlation IDs in error responses so clients can report them
