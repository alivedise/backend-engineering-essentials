...
Unit tests exercise a single function, class, or module in isolation. External dependencies — databases, network calls, file systems — are replaced with test doubles (see [BEE-2005](../security-fundamentals/cryptographic-basics-for-engineers.md)4).
...
- [BEE-15002](integration-testing-for-backend-services.md) (Integration Testing for Backend Services) — detailed guidance on writing integration tests with real databases and test containers
- [BEE-15003](contract-testing.md) (Contract Testing) — validate cross-service contracts without running full E2E suites
- [BEE-15004](load-testing-and-benchmarking.md) (Load Testing and Benchmarking) — performance validation outside the functional test pyramid
- [BEE-15005](test-doubles-mocks-stubs-fakes.md) (Test Doubles: Mocks, Stubs, Fakes) — how to isolate units for the base of the pyramid without compromising test value
