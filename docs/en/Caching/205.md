...
- [BEE-52: HTTP Fundamentals](../../HTTP/52.md) -- request/response model, status codes, and headers
- [BEE-200: Caching Fundamentals and Cache Hierarchy](./200.md) -- TTL, eviction, and consistency concepts that underpin this article
- [BEE-304: CDN Architecture](../../Infrastructure/304.md) -- how CDN nodes consume and propagate `Cache-Control` directives
