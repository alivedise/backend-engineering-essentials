...
# [BEP-205] HTTP Caching and Conditional Requests
...
- [BEP-52: HTTP Fundamentals](../../HTTP/52.md) -- request/response model, status codes, and headers
- [BEP-200: Caching Fundamentals and Cache Hierarchy](./200.md) -- TTL, eviction, and consistency concepts that underpin this article
- [BEP-304: CDN Architecture](../../Infrastructure/304.md) -- how CDN nodes consume and propagate `Cache-Control` directives
