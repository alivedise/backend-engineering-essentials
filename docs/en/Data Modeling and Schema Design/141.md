...
# [BEP-141] Normalization and Denormalization

:::tip Deep Dive
For database-level normalization theory and formal definitions, see [DDP-100: Normalization](https://alivedise.github.io/database-design-principles/100).
:::
...
For complex read workloads, consider separating the write model (normalized) from the read model (denormalized and query-shaped). This is covered in depth in [BEP-102: CQRS](./102.md).
...
- [BEP-102: CQRS](./102.md) — separate read models as a structured denormalization pattern
- [BEP-120: SQL vs NoSQL](./120.md) — when document databases are a natural fit for denormalized data
- [BEP-140: Entity-Relationship Modeling](./140.md) — how to identify entities before normalizing
