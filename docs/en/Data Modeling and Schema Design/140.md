...
# [BEP-140] Entity-Relationship Modeling
...
:::tip Deep Dive
For database-level relationship implementation details, see [DDP-106: Relationships](https://alivedise.github.io/database-design-principles/103).
:::
...
- [BEP-101: Domain-Driven Design](../Domain%20Concepts%20and%20Glossary/101.md) — Bounded contexts and aggregates shape which entities belong to the same model.
- [BEP-120: SQL vs NoSQL](./120.md) — The ER model applies to relational databases; document stores require different modeling strategies.
- [BEP-141: Normalization](./141.md) — After translating ER to tables, normalization rules refine the physical design.
- [BEP-145: Polymorphism in Schema Design](./145.md) — When an entity has subtypes, ER modeling must decide between table-per-type, table-per-hierarchy, and other strategies.
