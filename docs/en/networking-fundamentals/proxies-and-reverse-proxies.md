...
- [BEE-3008](http-as-a-substrate-for-new-protocols.md) — HTTP as a Substrate for New Protocols: Streaming and Upgrade-based conventions only work end-to-end if intermediaries forward them correctly; this article inventories the conventions a reverse proxy needs to support
