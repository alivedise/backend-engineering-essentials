...
- [BEE-380](380.md) — Full-text search fundamentals: inverted index, BM25 scoring, and the analysis pipeline that underlies relevance
- [BEE-303](../Performance and Scalability/303.md) — Profiling and bottleneck identification: applies to search query latency alongside relevance quality
- [BEE-345](../Testing Strategies/345.md) — Testing in production: A/B testing methodology applies directly to relevance experiments
