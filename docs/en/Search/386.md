...
- [BEE-121](../Data Storage and Database Fundamentals/121.md) -- Indexing Deep Dive: the B-tree and GiST index structures that underpin database-level spatial indexes
- [BEE-123](../Data Storage and Database Fundamentals/123.md) -- Partitioning and Sharding: spatial partitioning by geohash or S2 cell is a common strategy for sharding location-heavy datasets
- [BEE-200](../Caching/200.md) -- Caching Fundamentals: proximity query results for popular locations (city centers, landmarks) are strong cache candidates
- [BEE-380](380.md) -- Full-Text Search Fundamentals: geospatial and text filters are frequently combined ("coffee shops near me")
