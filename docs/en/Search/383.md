...
- [BEE-380](380.md) -- Full-Text Search Fundamentals: inverted index, BM25, and the keyword retrieval layer that pairs with vector search in hybrid architectures
- [BEE-381](381.md) -- Search Relevance Tuning: field boosting and scoring strategies applicable to both keyword and hybrid search pipelines
- [BEE-382](382.md) -- Faceted Search and Filtering: metadata filtering, which intersects with the filtered ANN search problem
