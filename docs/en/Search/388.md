...
- [BEE-380](380.md) -- Full-Text Search Fundamentals: the inverted index and BM25 scoring that analytics aims to improve
- [BEE-381](381.md) -- Search Relevance Tuning: the manual tuning process that analytics data informs and eventually replaces
- [BEE-383](383.md) -- Vector Search and Semantic Search: offline Recall@K metrics apply directly to ANN index evaluation
