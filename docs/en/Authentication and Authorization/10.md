...
# [BEP-10] Authentication vs Authorization
...
OAuth 2.0 is an authorization delegation framework. An access token proves that a resource owner delegated certain scopes — it does not authenticate the user to your application. Use OpenID Connect (OIDC) on top of OAuth 2.0 when you need verified user identity. (See BEP-12.)
...
- [BEP-11: Token-Based Authentication](/en/Authentication%20and%20Authorization/11) — how tokens establish identity
- [BEP-12: OAuth 2.0 and OpenID Connect](/en/Authentication%20and%20Authorization/12) — delegation vs. authentication
- [BEP-13: Session Management](/en/Authentication%20and%20Authorization/13) — maintaining authenticated state
- [BEP-14: RBAC vs ABAC](/en/Authentication%20and%20Authorization/14) — permission models in depth
- [BEP-15: API Key Management](/en/Authentication%20and%20Authorization/15) — API credential patterns
