...
- [BEE-11: Token-Based Authentication](/en/Authentication%20and%20Authorization/11) — how tokens establish identity
- [BEE-12: OAuth 2.0 and OpenID Connect](/en/Authentication%20and%20Authorization/12) — delegation vs. authentication
- [BEE-13: Session Management](/en/Authentication%20and%20Authorization/13) — maintaining authenticated state
- [BEE-14: RBAC vs ABAC](/en/Authentication%20and%20Authorization/14) — permission models in depth
- [BEE-15: API Key Management](/en/Authentication%20and%20Authorization/15) — API credential patterns
