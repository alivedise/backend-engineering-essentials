...
- [BEE-10: Authentication vs Authorization](/en/Authentication%20and%20Authorization/10) — the conceptual boundary between identity and permission
- [BEE-11: Token-Based Authentication](/en/Authentication%20and%20Authorization/11) — short-lived tokens as an alternative for user-delegated access
- [BEE-31: Secrets Management](/en/Security%20Fundamentals/31) — storing and rotating credentials in production infrastructure
- [BEE-71: Rate Limiting and Throttling](/en/Reliability%20and%20Performance/71) — per-key rate limiting strategies
