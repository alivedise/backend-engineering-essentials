...
- [BEE-10: Authentication vs Authorization](/en/Authentication%20and%20Authorization/10) — the pipeline that precedes any permission model
- [BEE-12: OAuth 2.0 and OpenID Connect](/en/Authentication%20and%20Authorization/12) — how scopes relate to coarse-grained RBAC at the protocol level
- [BEE-101: API Gateway Patterns](/en/API%20Design%20and%20Contracts/101) — enforcement points in a gateway-first architecture
