...
- [BEP-10: Authentication vs Authorization](/en/Authentication%20and%20Authorization/10) — identity pipeline context
- [BEP-11: Token-Based Authentication](/en/Authentication%20and%20Authorization/11) — stateless alternative to sessions
- [BEP-30: Transport Security](/en/30) — HTTPS requirement underlying Secure cookie
- [BEP-33: Secrets Management](/en/33) — handling secrets in session stores
