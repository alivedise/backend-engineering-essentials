...
# [BEP-11] Token-Based Authentication
...
- [BEP-11: OAuth 2.0 and OpenID Connect](/en/Authentication%20and%20Authorization/11) — token issuance and delegation flows
- [BEP-13: Session Management](/en/Authentication%20and%20Authorization/13) — server-side sessions as an alternative to tokens
- [BEP-30: OWASP Top 10 Mapping](/en/Security%20Fundamentals/30) — security vulnerability context
- [BEP-31: Cryptographic Primitives](/en/Security%20Fundamentals/31) — signing algorithms and key management basics
