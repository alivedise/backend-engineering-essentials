...
Best practices:
- All schema changes must be applied via migrations (see [BEE-1003](../auth/oauth-openid-connect.md)6).
...
- [BEE-4002](../api-design/api-versioning-strategies.md) — API Versioning: when schema evolution is insufficient and a version bump is required
- [BEE-6007](../data-storage/database-migrations.md) — Database Migrations: applying schema changes to persistent storage safely
- [BEE-7004](encoding-and-serialization-formats.md) — Encoding Formats: choosing between Protobuf, Avro, JSON, and MessagePack
