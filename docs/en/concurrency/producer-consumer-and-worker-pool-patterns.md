...
- [BEE-10006](../messaging/backpressure-and-flow-control.md) — Backpressure: system-level strategies for propagating load signals upstream
- [BEE-11001](threads-vs-processes-vs-coroutines.md) — Threads vs Processes vs Coroutines: the primitives that worker pools are built on
- [BEE-11004](async-i-o-and-event-loops.md) — Async I/O and Event Loops: the alternative to thread pools for I/O-bound work
- [BEE-13006](../performance-scalability/asynchronous-processing-and-work-queues.md) — Async Processing and Job Queues: durable, distributed queues (Kafka, SQS) for cross-service task distribution
