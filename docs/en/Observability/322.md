...
- **BEP-320** — The three pillars: how traces relate to metrics and logs
- **BEP-321** — Structured logging: embedding `trace_id` and `span_id` in log entries
- **BEP-105** — Service mesh: how mesh-layer tracing complements application-level instrumentation
