...
- [BEE-320](320.md) — The three pillars: how traces relate to metrics and logs
- [BEE-321](321.md) — Structured logging: embedding `trace_id` and `span_id` in log entries
- [BEE-105](105.md) — Service mesh: how mesh-layer tracing complements application-level instrumentation
