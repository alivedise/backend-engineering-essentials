...
- [BEE-8001](../transactions/acid-properties.md) -- ACID Properties: ACID consistency is application-level correctness; CAP consistency is replication synchronization — distinct concepts
- [BEE-8002](../transactions/isolation-levels-and-their-anomalies.md) -- Isolation Levels: isolation levels govern what concurrent transactions see; CAP governs what distributed replicas return
- [BEE-8003](../transactions/distributed-transactions-and-two-phase-commit.md) -- Distributed Transactions and Two-Phase Commit: 2PC is a CP protocol — it halts rather than permit inconsistency during coordinator failure
- [BEE-8006](../transactions/eventual-consistency-patterns.md) -- Eventual Consistency Patterns: implementation strategies for AP systems, including conflict resolution and CRDT approaches
- [BEE-9004](../caching/distributed-caching.md) -- Distributed Caching: caches are inherently AP — understanding CAP explains why cache invalidation is hard
- [BEE-6003](../data-storage/replication-strategies.md) -- Replication Strategies: synchronous vs asynchronous replication is the physical mechanism underlying the CP/AP choice
