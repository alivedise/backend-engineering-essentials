...
| Python | `pybreaker` |
| Node.js | `opossum` |
| Service mesh | Envoy (Istio, Linkerd) — see [BEE-105](105.md) |
...
- [BEE-261](261.md) (Retry Strategies and Exponential Backoff) — complement circuit breakers with retry for transient faults
- [BEE-262](262.md) (Timeouts and Deadlines) — always pair timeouts with circuit breakers; a long timeout delays circuit opening
- [BEE-263](263.md) (Bulkhead Pattern) — isolate thread pools to contain failure blast radius
- [BEE-264](264.md) (Graceful Degradation) — defines how to handle fallback behavior when the circuit is open
- [BEE-105](105.md) (Service Mesh) — service mesh provides circuit breaking as infrastructure-level policy
