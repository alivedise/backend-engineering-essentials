...
- [BEE-260](260.md) (Circuit Breaker Pattern) — circuit breakers trigger degradation when a dependency fails; [BEE-264](264.md) defines what the fallback looks like
- [BEE-263](263.md) (Bulkhead Pattern) — bulkheads isolate resources by dependency; when a partition is full, graceful degradation determines what is returned
- [BEE-266](266.md) (Rate Limiting and Throttling) — rate limiting as a form of load shedding for inbound traffic
- [BEE-363](363.md) (Feature Flags) — runtime kill switches for disabling non-critical features during degradation
