...
2. The operation accepts an idempotency key that the server uses to deduplicate (see [BEE-71](71.md) and [BEE-16](16.md)1)
...
- [BEE-71](71.md) — Idempotency keys for safe retries
- [BEE-161](161.md) — Exactly-once delivery via deduplication
- [BEE-260](260.md) — Circuit breakers to stop retrying failed services
- [BEE-261](261.md) — Timeouts to bound retry latency
