...
Webhooks operate under **at-least-once delivery** semantics. The sender retries until it receives a 2xx response or exhausts its retry budget. This means consumers must be idempotent (see [BEE-4003](api-idempotency.md)).
...
If processing takes more than 10 seconds, the sender will likely time out and retry. Always offload work to a queue (see [BEE-10001](../messaging/message-queues-vs-event-streams.md)).
...
- [BEE-2005](../security-fundamentals/cryptographic-basics-for-engineers.md) — HMAC cryptographic primitives
- [BEE-4003](api-idempotency.md) — Idempotency in APIs
- [BEE-10001](../messaging/message-queues-vs-event-streams.md) — Messaging patterns and async processing
- [BEE-12002](../resilience/retry-strategies-and-exponential-backoff.md) — Retry strategies and exponential backoff
