...
:::tip Deep Dive
For API-level idempotency design patterns and governance, see [ADE (API Design Essentials)](https://alivedise.github.io/api-design-essentials/).
:::
...
- [BEE-4001](rest-api-design-principles.md) — REST API Design Principles: HTTP method semantics and resource modeling
- [BEE-8005](../transactions/idempotency-and-exactly-once-semantics.md) — Idempotency in Messaging: applying the same guarantees to async message queues
- [BEE-12002](../resilience/retry-strategies-and-exponential-backoff.md) — Retry Strategies: exponential backoff, jitter, and client-side retry budgets
