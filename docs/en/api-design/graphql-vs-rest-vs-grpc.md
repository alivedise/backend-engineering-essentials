...
See [BEE-4001](rest-api-design-principles.md) for the full treatment of REST architectural constraints and HTTP method semantics.
...
See [BEE-3003](../networking-fundamentals/http-versions.md) for HTTP/2 fundamentals including multiplexing and header compression, which gRPC relies on.
