...
- [BEE-10](10.md) -- Authentication vs Authorization: tenant identity must be established before tenant context can be set
- [BEE-13](13.md) -- Session Management: sessions in multi-tenant systems carry tenant identity as a first-class claim
- [BEE-123](123.md) -- Partitioning and Sharding: silo and bridge models at scale become a form of tenant-keyed sharding
- [BEE-161](161.md) -- Isolation Levels and Their Anomalies: RLS interacts with transaction isolation; understand both layers
