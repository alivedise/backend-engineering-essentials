...
- [BEE-400](400.md) -- Multi-Tenancy Models: the deployment models that this quota enforcement protects
- [BEE-401](401.md) -- Tenant Isolation Strategies: data isolation; quotas are the compute and API-access complement
- [BEE-266](266.md) -- Rate Limiting and Throttling: general rate limiting concepts and algorithms; this article applies them specifically to multi-tenant contexts
- [BEE-164](164.md) -- Idempotency and Exactly-Once Semantics: quota counters must be incremented exactly once per request, even under retries
