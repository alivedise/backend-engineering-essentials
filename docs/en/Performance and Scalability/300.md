...
- **BEE-301** — Scaling decisions: how estimates inform horizontal vs vertical scaling choices
- **BEE-123** — Sharding: the threshold at which data volume exceeds a single node's capacity
