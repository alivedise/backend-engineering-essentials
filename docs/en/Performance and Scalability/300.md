...
# [BEP-300] Back-of-Envelope Estimation
...
- **BEP-301** — Scaling decisions: how estimates inform horizontal vs vertical scaling choices
- **BEP-123** — Sharding: the threshold at which data volume exceeds a single node's capacity
