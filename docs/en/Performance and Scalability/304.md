...
# [BEP-304] Content Delivery and Edge Computing
...
- [BEP-55](../Foundations/55.md) — Reverse proxy patterns
- [BEP-200](../Performance and Scalability/200.md) — Caching principles
- [BEP-205](../Performance and Scalability/205.md) — HTTP caching headers
- [BEP-301](../Performance and Scalability/301.md) — Horizontal and vertical scaling
