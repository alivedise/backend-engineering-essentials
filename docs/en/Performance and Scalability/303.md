...
5. **Add or fix the index** — See [BEE-121](121.md) for indexing principles.
...
See [BEE-321](321.md) for SLO definitions based on percentile targets.
...
- [BEE-121](121.md) — Indexing strategy for query optimization
- [BEE-125](125.md) — Query optimization principles
- [BEE-320](320.md) — Observability metrics design
- [BEE-321](321.md) — SLO definition and percentile targets
