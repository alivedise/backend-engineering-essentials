...
# [BEP-303] Profiling and Bottleneck Identification
...
5. **Add or fix the index** — See [BEP-121](../Data Management/121.md) for indexing principles.
...
See [BEP-321](../Reliability and Observability/321.md) for SLO definitions based on percentile targets.
...
- [BEP-121](../Data Management/121.md) — Indexing strategy for query optimization
- [BEP-125](../Data Management/125.md) — Query optimization principles
- [BEP-320](../Reliability and Observability/320.md) — Observability metrics design
- [BEP-321](../Reliability and Observability/321.md) — SLO definition and percentile targets
