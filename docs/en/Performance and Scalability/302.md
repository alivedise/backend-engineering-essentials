...
# [BEP-302] Connection Pooling and Resource Management
...
See [BEP-244](/en/Performance%20and%20Scalability/244) for worker and thread pool design specifics.
...
- [BEP-125](/en/Data%20Management%20and%20Storage/125) — Database-specific pooling and query optimization
- [BEP-244](/en/Performance%20and%20Scalability/244) — Worker and thread pool design
- [BEP-262](/en/Performance%20and%20Scalability/262) — Timeout configuration, including pool acquisition timeouts
