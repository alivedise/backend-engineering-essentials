...
See [BEE-244](244.md) for worker and thread pool design specifics.
...
- [BEE-125](125.md) — Database-specific pooling and query optimization
- [BEE-244](244.md) — Worker and thread pool design
- [BEE-262](262.md) — Timeout configuration, including pool acquisition timeouts
