...
- [BEE-30: OWASP Top 10 for Backend](/en/Security%20Fundamentals/30) — A06 Vulnerable and Outdated Components in context of the full Top 10
- [BEE-31: Secrets Management](/en/Security%20Fundamentals/31) — credential leaks via compromised dependencies
- [BEE-365: Pipeline Design](/en/pipelines/365) — CI/CD pipeline security controls and artifact signing
