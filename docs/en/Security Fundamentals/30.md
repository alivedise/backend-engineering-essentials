...
# [BEP-30] OWASP Top 10 for Backend
...
Backend relevance: access control must be enforced server-side on every request. See BEP-10.
...
Backend relevance: every data-at-rest and data-in-transit decision involves cryptography. See BEP-34.
...
Backend relevance: injection attacks target the data layer and any system call that constructs commands from input. See BEP-31.
...
Backend relevance: configuration must be audited per environment. Production and development configs must differ. See BEP-33 for CORS specifics.
...
Backend relevance: dependency inventory, automated vulnerability scanning, and timely patching are non-negotiable. See BEP-35.
...
- [BEP-10: Authentication vs Authorization](/en/Authentication%20and%20Authorization/10) — foundational access control pipeline (A01, A07)
- [BEP-31: Input Validation and Sanitization](/en/Security%20Fundamentals/31) — defending against injection (A03)
- [BEP-32: Secrets Management](/en/Security%20Fundamentals/32) — protecting credentials and keys (A02)
- [BEP-33: CORS and Same-Origin Policy](/en/Security%20Fundamentals/33) — browser-side access control configuration (A05)
- [BEP-34: Cryptographic Basics for Engineers](/en/Security%20Fundamentals/34) — encryption and hashing fundamentals (A02)
- [BEP-35: Dependency Security and Supply Chain](/en/Security%20Fundamentals/35) — managing third-party risk (A06)
