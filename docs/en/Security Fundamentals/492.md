...
- [BEE-30](30.md) -- OWASP Top 10 for Backend: A03:2021 Injection is the umbrella category; this article covers the SQL-specific implementation mechanics
- [BEE-31](31.md) -- Input Validation and Sanitization: the broader principle of untrusted input handling; parameterization is the definitive defense at the database boundary
- [BEE-488](488.md) -- OWASP API Security Top 10: SQL injection surfaces as a risk in API contexts (API10: Unsafe Consumption when processing third-party data)
