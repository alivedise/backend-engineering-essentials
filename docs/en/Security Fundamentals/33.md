...
# [BEP-33] CORS and Same-Origin Policy
...
- **BEP-30** — OWASP Top 10 for Backend: CORS misconfiguration contributes to broken access control (A01) and security misconfiguration (A05).
- **BEP-50** — Networking Fundamentals: TCP/IP and HTTP request routing context.
- **BEP-51** — HTTP Semantics: Request methods, status codes, and header conventions that underpin CORS behavior.
