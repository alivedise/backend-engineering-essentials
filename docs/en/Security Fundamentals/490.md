...
- [BEE-32](32.md) -- Secrets Management: runtime injection of secrets (passwords, tokens) into processes; this article covers cryptographic key lifecycle which goes beyond secrets injection
- [BEE-34](34.md) -- Cryptographic Basics for Engineers: algorithm and mode selection; this article covers what happens after the algorithm is chosen — key lifecycle management
- [BEE-489](489.md) -- HTTP Security Headers: TLS and HSTS protect transport keys; application-layer key management protects data keys
- [BEE-482](../Security/482.md) -- Zero-Trust Security Architecture: key management is a component of zero-trust; identity-based access to KMS operations replaces network-perimeter trust
