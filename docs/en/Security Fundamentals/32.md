...
- [BEP-15: API Keys](../API%20Design/15.md) — How to design and issue API keys for external consumers.
- [BEP-34: Cryptography](./34.md) — Key lengths, algorithm selection, and encryption at rest.
- [BEP-35: Dependency Security](./35.md) — Supply chain risks that can expose secrets indirectly.
