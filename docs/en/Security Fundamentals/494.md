...
- [BEE-35](35.md) -- Dependency Security and Supply Chain: application-layer software supply chain (npm/pip/Maven); this article covers the container image layer of the same problem
- [BEE-364](../CI,CD and DevOps/364.md) -- Container Fundamentals: how containers and images work; this article covers how to secure them
- [BEE-490](490.md) -- Cryptographic Key Management and Key Rotation: the private keys used for image signing are subject to all key management requirements
- [BEE-491](491.md) -- TLS Certificate Lifecycle and PKI: Sigstore's Fulcio issues short-lived X.509 certificates; the PKI concepts apply directly
