...
- [BEE-525](525.md) -- Chain-of-Thought and Extended Thinking Patterns: prompt-level reasoning strategies
- [BEE-526](526.md) -- LLM Caching Strategies: prompt cache mechanics that thinking config affects
- [BEE-513](513.md) -- AI Cost Optimization and Model Routing: routing decisions for thinking-enabled models
