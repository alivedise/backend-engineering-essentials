...
- [BEE-565](565.md) -- Prefix Caching and KV Cache Reuse: prefix caching hit rates degrade when extended context fragments shared prefix blocks
- [BEE-567](567.md) -- Continuous Batching and Iteration-Level Scheduling: chunked prefill is required to serve 128K-token requests without blocking the batch
- [BEE-568](568.md) -- Tensor Parallelism and Pipeline Parallelism: long-context KV cache pressure changes the TP/PP balance needed
- [BEE-512](512.md) -- LLM Context Window Management: application-level strategies for staying within context limits
