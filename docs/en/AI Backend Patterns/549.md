...
- [BEE-512](512.md) -- LLM Context Window Management: context window strategies and sliding window approaches that complement compression
- [BEE-526](526.md) -- LLM Caching Strategies: prompt caching at the provider level eliminates token costs for repeated identical prefixes — the first line of defense before compression
- [BEE-519](519.md) -- AI Memory Systems for Long-Running Agents: episodic and semantic memory architectures that reduce what needs to go in context at all
- [BEE-531](531.md) -- Advanced RAG and Agentic Retrieval Patterns: selective retrieval that reduces document count before compression is applied
