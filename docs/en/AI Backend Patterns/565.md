...
- [BEE-526](526.md) -- LLM Caching Strategies: response-level caching, distinct from KV tensor reuse
- [BEE-558](558.md) -- Semantic Caching for LLM Applications: embedding-based near-duplicate detection, complements exact prefix caching
- [BEE-560](560.md) -- LLM Load Testing and Capacity Planning: TTFT measurement for validating prefix cache gains
- [BEE-564](564.md) -- FlashAttention and Efficient Attention Kernels: prefill computation that prefix caching avoids
