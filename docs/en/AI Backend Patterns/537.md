...
- [BEE-504](504.md) -- AI Agent Architecture Patterns: the agent loop design that these safety layers wrap
- [BEE-520](520.md) -- LLM Tool Use and Function Calling Patterns: the tool dispatch mechanism that circuit breakers and policy gates intercept
- [BEE-524](524.md) -- Human-in-the-Loop AI Patterns: the approval gate mechanics and confidence-based routing that the policy layer triggers
- [BEE-260](260.md) -- Circuit Breaker Pattern: the general circuit breaker pattern applied here to per-tool reliability
- [BEE-461](461.md) -- The N+1 Query Problem and Batch Loading: retry storms in agent tool calls are an agentic analog of the N+1 query problem
