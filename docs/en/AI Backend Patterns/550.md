...
- [BEE-523](523.md) -- LLM Inference Optimization and Self-Hosting: vLLM, continuous batching, and KV cache optimization for serving quantized models efficiently
- [BEE-514](514.md) -- Fine-Tuning and PEFT Patterns: LoRA and QLoRA for adapting a quantized model to a specific task without full retraining
- [BEE-513](513.md) -- AI Cost Optimization and Model Routing: routing requests to the smallest capable model is the operational complement to model compression
