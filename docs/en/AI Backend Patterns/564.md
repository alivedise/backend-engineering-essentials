...
- [BEE-560](560.md) -- LLM Load Testing and Capacity Planning: TTFT and ITL metrics for measuring FA and FlashDecoding gains
- [BEE-561](561.md) -- Speculative Decoding for LLM Inference: orthogonal technique; FlashAttention and speculative decoding can be combined
- [BEE-563](563.md) -- LLM Quantization for Inference: FA3 FP8 mode combines quantization and tiling
