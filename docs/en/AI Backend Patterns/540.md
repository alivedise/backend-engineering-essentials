...
- [BEE-506](506.md) -- Evaluating and Testing LLM Applications: the offline golden-dataset evaluation that gates deployments
- [BEE-511](511.md) -- LLM Observability and Monitoring: the trace collection and metrics infrastructure that feeds the flywheel
- [BEE-514](514.md) -- Fine-Tuning and PEFT Patterns: the SFT and LoRA mechanisms that the flywheel drives
- [BEE-524](524.md) -- Human-in-the-Loop AI Patterns: the human review queue that labels selected traces
- [BEE-530](530.md) -- Prompt Management and Versioning: prompt updates as a fast-path improvement action
- [BEE-534](534.md) -- Synthetic Data Generation for AI Systems: synthetic preference pairs for verifiable domains
- [BEE-536](536.md) -- AI Experimentation and Model A/B Testing: the shadow mode and canary ramp used for improvement deployment
