...
- [BEE-523](523.md) -- LLM Inference Optimization and Self-Hosting: hardware selection and overall inference optimization
- [BEE-566](566.md) -- Mixture of Experts Architecture and Serving: Expert Parallel interacts with TP/PP scheduling
- [BEE-567](567.md) -- Continuous Batching and Iteration-Level Scheduling: micro-batching for PP interacts with continuous batch scheduler
- [BEE-563](563.md) -- LLM Quantization for Inference: reduces memory per GPU, changing the TP degree needed
