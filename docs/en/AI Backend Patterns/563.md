...
- [BEE-523](523.md) -- LLM Inference Optimization and Self-Hosting: the broader optimization landscape that quantization fits into
- [BEE-561](561.md) -- Speculative Decoding for LLM Inference: interacts with quantized hidden states; validate acceptance rate after quantizing
- [BEE-562](562.md) -- Multi-LoRA Serving and Adapter Management: LoRA adapters trained in FP16 must be dequantized to match the adapter's original precision; vLLM handles this automatically
