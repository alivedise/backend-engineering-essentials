...
- [BEE-509](509.md) -- RAG Pipeline Architecture: the vector retrieval foundation that GraphRAG extends
- [BEE-531](531.md) -- Advanced RAG and Agentic Retrieval Patterns: multi-hop and agent-driven retrieval strategies
- [BEE-517](517.md) -- Retrieval Reranking and Hybrid Search: combining vector and graph signals
