...
- [BEE-513](513.md) -- AI Cost Optimization and Model Routing: using routing to select cheaper model tiers based on query complexity
- [BEE-516](516.md) -- Embedding Models and Vector Representations: the embedding model choice that underlies similarity-based routing
- [BEE-504](504.md) -- AI Agent Architecture Patterns: routing to different specialized agents rather than model tiers
- [BEE-517](517.md) -- Retrieval Reranking and Hybrid Search: rerankers repurposed as high-accuracy zero-shot classifiers
