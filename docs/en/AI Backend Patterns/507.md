...
- [BEE-503](503.md) -- LLM API Integration Patterns: token cost management, streaming, and semantic caching apply regardless of customization strategy
- [BEE-506](506.md) -- Evaluating and Testing LLM Applications: the RAGAS metrics, golden datasets, and LLM-as-judge patterns are the evaluation tools for measuring whether each customization strategy succeeded
- [BEE-383](383.md) -- Vector Search and Semantic Search: the retrieval component of RAG is a vector search problem; chunking, embedding, and top-k retrieval patterns are covered there
- [BEE-200](200.md) -- Caching Fundamentals: fine-tuned model responses are more predictable and thus more cache-friendly; semantic caching applies to both RAG and non-RAG LLM calls
