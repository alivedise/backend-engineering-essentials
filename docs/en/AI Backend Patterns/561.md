...
- [BEE-523](523.md) -- LLM Inference Optimization and Self-Hosting: the broader optimization landscape that speculative decoding fits into
- [BEE-560](560.md) -- LLM Load Testing and Capacity Planning: measuring TTFT/ITL to validate speculative decoding gains
- [BEE-513](513.md) -- AI Cost Optimization and Model Routing: choosing smaller models to reduce cost, complementary to speculative decoding
