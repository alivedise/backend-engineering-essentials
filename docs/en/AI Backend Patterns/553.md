...
- [BEE-549](549.md) -- LLM Prompt Compression and Token Efficiency: compression techniques to apply once a token count exceeds the budget
- [BEE-512](512.md) -- LLM Context Window Management: sliding window and memory strategies for long conversations
- [BEE-513](513.md) -- AI Cost Optimization and Model Routing: routing requests to smaller models to reduce token cost
