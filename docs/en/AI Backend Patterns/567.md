...
- [BEE-523](523.md) -- LLM Inference Optimization and Self-Hosting: the broader inference optimization landscape including hardware selection
- [BEE-565](565.md) -- Prefix Caching and KV Cache Reuse: how KV cache block reuse integrates with the continuous batching scheduler
- [BEE-566](566.md) -- Mixture of Experts Architecture and Serving: MoE expert dispatch interacts with batch scheduling via Expert Parallel
- [BEE-560](560.md) -- LLM Load Testing and Capacity Planning: measuring TTFT, ITL, and throughput under continuous batching
