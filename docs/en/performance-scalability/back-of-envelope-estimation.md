...
- [BEE-13002](horizontal-vs-vertical-scaling.md) — Scaling decisions: how estimates inform horizontal vs vertical scaling choices
- [BEE-6004](../data-storage/partitioning-and-sharding.md) — Sharding: the threshold at which data volume exceeds a single node's capacity
