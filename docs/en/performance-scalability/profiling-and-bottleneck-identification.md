...
5. **Add or fix the index** — See [BEE-6002](../data-storage/indexing-deep-dive.md) for indexing principles.
...
See [BEE-14002](../observability/structured-logging.md) for SLO definitions based on percentile targets.
...
- [BEE-6002](../data-storage/indexing-deep-dive.md) — Indexing strategy for query optimization
- [BEE-6006](../data-storage/connection-pooling-and-query-optimization.md) — Query optimization principles
- [BEE-14001](../observability/three-pillars-logs-metrics-traces.md) — Observability metrics design
- [BEE-14002](../observability/structured-logging.md) — SLO definition and percentile targets
