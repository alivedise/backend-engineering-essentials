...
See [BEE-10006](../messaging/backpressure-and-flow-control.md) for backpressure patterns.
...
- [BEE-10001](../messaging/message-queues-vs-event-streams.md) — Messaging and event-driven architecture
- [BEE-10002](../messaging/publish-subscribe-pattern.md) — Dead-letter queues
- [BEE-10006](../messaging/backpressure-and-flow-control.md) — Backpressure patterns
- [BEE-11002](../concurrency/race-conditions-and-data-races.md) — Worker pools
