...
- **[BEE-5001](monolith-vs-microservices-vs-modular-monolith.md) (Monolith to Microservices)** -- The strangler fig is the recommended migration strategy when decomposing a monolith. [BEE-5001](monolith-vs-microservices-vs-modular-monolith.md) defines the architectural destination; [BEE-5005](strangler-fig-pattern.md) describes how to get there without stopping traffic.
- **[BEE-5002](domain-driven-design-essentials.md) (Domain-Driven Design)** -- DDD bounded contexts map directly to strangler fig migration units. Migrate one bounded context at a time; context boundaries give you natural seams where the facade can split traffic.
- **[BEE-6007](../data-storage/database-migrations.md) (Database Migrations)** -- Data migration runs in parallel with service migration. [BEE-6007](../data-storage/database-migrations.md) covers the techniques (dual writes, CDC, backfill) in depth.
...
- [BEE-5001](monolith-vs-microservices-vs-modular-monolith.md): Monolith vs Microservices vs Modular Monolith
- [BEE-5002](domain-driven-design-essentials.md): Domain-Driven Design Essentials
- [BEE-6007](../data-storage/database-migrations.md): Database Migrations
