...
When a specific module requires independent scaling, team autonomy, or technology heterogeneity, it is a candidate for extraction. Use the Strangler Fig pattern (see [BEE-1001](../auth/authentication-vs-authorization.md)4) to extract the module incrementally:
...
- [BEE-5002](domain-driven-design-essentials.md) -- Domain-Driven Design Essentials: using bounded contexts to identify module and service boundaries
- [BEE-5005](strangler-fig-pattern.md) -- Strangler Fig Pattern: incremental migration from monolith to services
- [BEE-5006](sidecar-and-service-mesh-concepts.md) -- Sidecar and Service Mesh Concepts: infrastructure for microservice communication
