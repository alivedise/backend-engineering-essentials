...
- [BEE-17001](full-text-search-fundamentals.md) -- Full-Text Search Fundamentals: the analysis pipeline and inverted index that fuzzy queries operate against
- [BEE-17002](search-relevance-tuning.md) -- Search Relevance Tuning: fuzzy matches should receive lower boost scores than exact matches in relevance scoring
- [BEE-17006](autocomplete-and-typeahead-search.md) -- Autocomplete and Typeahead Search: autocomplete is complementary to spelling correction — autocomplete prevents errors; correction handles them after they occur
