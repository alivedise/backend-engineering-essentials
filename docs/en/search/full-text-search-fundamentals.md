...
- [BEE-5001](../architecture-patterns/monolith-vs-microservices-vs-modular-monolith.md) -- Database Fundamentals: storage engines and index structures that underpin both relational and search systems.
- [BEE-13001](../performance-scalability/back-of-envelope-estimation.md) -- Architecture Patterns Overview: where to place a search engine in a broader system design.
