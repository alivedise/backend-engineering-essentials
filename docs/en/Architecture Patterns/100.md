...
When a specific module requires independent scaling, team autonomy, or technology heterogeneity, it is a candidate for extraction. Use the Strangler Fig pattern (see BEE-104) to extract the module incrementally:
