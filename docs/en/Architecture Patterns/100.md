...
When a specific module requires independent scaling, team autonomy, or technology heterogeneity, it is a candidate for extraction. Use the Strangler Fig pattern (see BEP-104) to extract the module incrementally:
...
- [BEP-101](101.md) -- Domain-Driven Design Essentials: using bounded contexts to identify module and service boundaries
- [BEP-104](104.md) -- Strangler Fig Pattern: incremental migration from monolith to services
- [BEP-105](105.md) -- Sidecar and Service Mesh Concepts: infrastructure for microservice communication
