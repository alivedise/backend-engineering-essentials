...
- **DDD** (see [BEE-101](./101.md)) -- hexagonal architecture is a natural structural complement to DDD. Domain aggregates, entities, and value objects live in the core; repositories are driven ports.
- **CQRS** (see [BEE-101](./101.md)) -- command and query handlers are use cases in the domain core; read model adapters and write adapters are driven adapters.
...
- [BEE-100](100.md): Architecture Patterns Overview
- [BEE-101](101.md): Domain-Driven Design
- [BEE-101](101.md): CQRS
- [BEE-341](341.md): Test Doubles
