...
This article focuses primarily on strategic DDD, which directly informs how to draw boundaries between modules and services (see [BEE-10](10.md)0).
...
- [BEE-100](100.md) -- Architecture Patterns: bounded contexts directly inform where to draw module and service boundaries in a monolith or microservices architecture
- [BEE-102](102.md) -- CQRS: a natural companion to DDD; domain events enable the read model in CQRS
- [BEE-140](140.md) -- Data Modeling: how bounded context ownership maps to database schema design
