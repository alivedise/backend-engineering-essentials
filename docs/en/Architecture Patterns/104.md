...
- **[BEE-100](100.md) (Monolith to Microservices)** -- The strangler fig is the recommended migration strategy when decomposing a monolith. [BEE-100](100.md) defines the architectural destination; [BEE-104](104.md) describes how to get there without stopping traffic.
- **[BEE-101](101.md) (Domain-Driven Design)** -- DDD bounded contexts map directly to strangler fig migration units. Migrate one bounded context at a time; context boundaries give you natural seams where the facade can split traffic.
- **[BEE-126](126.md) (Database Migrations)** -- Data migration runs in parallel with service migration. [BEE-126](126.md) covers the techniques (dual writes, CDC, backfill) in depth.
...
- [BEE-100](100.md): Monolith vs Microservices vs Modular Monolith
- [BEE-101](101.md): Domain-Driven Design Essentials
- [BEE-126](126.md): Database Migrations
