...
- **Version your error contract** — changing error codes, error bodies, or the structure of problem details (see BEE-75) is a breaking change.
...
- [BEE-71](71.md) Idempotency in APIs
- [BEE-75](75.md) API Error Handling and Problem Details
- [BEE-141](../Data Modeling and Storage/141.md) Schema Evolution
