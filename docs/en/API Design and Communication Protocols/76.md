...
Webhooks operate under **at-least-once delivery** semantics. The sender retries until it receives a 2xx response or exhausts its retry budget. This means consumers must be idempotent (see [BEE-72](72.md)).
...
If processing takes more than 10 seconds, the sender will likely time out and retry. Always offload work to a queue (see [BEE-220](220.md)).
...
- [BEE-34](34.md) — HMAC cryptographic primitives
- [BEE-72](72.md) — Idempotency in APIs
- [BEE-220](220.md) — Messaging patterns and async processing
- [BEE-261](261.md) — Retry strategies and exponential backoff
