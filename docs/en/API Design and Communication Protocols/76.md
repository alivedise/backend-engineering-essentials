...
Webhooks operate under **at-least-once delivery** semantics. The sender retries until it receives a 2xx response or exhausts its retry budget. This means consumers must be idempotent (see [BEE-72](/en/API%20Design%20and%20Communication%20Protocols/72)).
...
If processing takes more than 10 seconds, the sender will likely time out and retry. Always offload work to a queue (see [BEE-220](/en/API%20Design%20and%20Communication%20Protocols/220)).
...
- [BEE-34](/en/Security%20and%20Resilience/34) — HMAC cryptographic primitives
- [BEE-72](/en/API%20Design%20and%20Communication%20Protocols/72) — Idempotency in APIs
- [BEE-220](/en/API%20Design%20and%20Communication%20Protocols/220) — Messaging patterns and async processing
- [BEE-261](/en/Reliability%20and%20Operations/261) — Retry strategies and exponential backoff
