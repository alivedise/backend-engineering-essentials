...
- [BEE-70](70.md) — REST API Design Principles: HTTP method semantics and resource modeling
- [BEE-164](164.md) — Idempotency in Messaging: applying the same guarantees to async message queues
- [BEE-261](261.md) — Retry Strategies: exponential backoff, jitter, and client-side retry budgets
