...
- **BEP-70** — REST API Design Principles: HTTP method semantics and resource modeling
- **BEP-164** — Idempotency in Messaging: applying the same guarantees to async message queues
- **BEP-261** — Retry Strategies: exponential backoff, jitter, and client-side retry budgets
