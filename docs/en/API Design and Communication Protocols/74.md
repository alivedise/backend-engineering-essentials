...
See [BEE-52](../Networking Fundamentals/52.md) for HTTP/2 fundamentals including multiplexing and header compression, which gRPC relies on.
...
- [BEE-52](../Networking Fundamentals/52.md) HTTP/2 and Transport Fundamentals (underpins gRPC)
