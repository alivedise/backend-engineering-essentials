...
See [BEP-70](70.md) for the full treatment of REST architectural constraints and HTTP method semantics.
...
See [BEP-52](../Networking Fundamentals/52.md) for HTTP/2 fundamentals including multiplexing and header compression, which gRPC relies on.
...
- [BEP-52](../Networking Fundamentals/52.md) HTTP/2 and Transport Fundamentals (underpins gRPC)
- [BEP-70](70.md) REST API Design Principles
- [BEP-76](76.md) Webhooks and Callback Patterns (async communication)
