...
- [BEP-70: REST API Design](./70.md) — Foundational REST conventions this article builds on.
- [BEP-125: Query Optimization](../Data Storage and Access Patterns/125.md) — Index strategies that make cursor pagination and keyset queries efficient.
