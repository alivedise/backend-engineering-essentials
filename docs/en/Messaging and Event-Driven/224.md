...
Structured log lines emitted when messages are routed to the DLQ enable log-based alerting (see [BEE-32](32.md)1):
...
- [BEE-222](222.md) — Delivery guarantees: at-most-once, at-least-once, and exactly-once semantics
- [BEE-261](261.md) — Retry strategies: exponential backoff, jitter, and retry budgets
- [BEE-321](321.md) — Structured logging: log formats for DLQ alerts and incident correlation
