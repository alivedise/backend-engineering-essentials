...
- [BEE-102](102.md) — CQRS: separating read and write models; event sourcing is the natural write-side pairing
- [BEE-144](144.md) — Temporal data: querying state as of a point in time
- [BEE-164](164.md) — Idempotency: projectors must be idempotent to support safe replay
- [BEE-220](220.md) — Event streams: the infrastructure layer that carries events between producers and projectors
