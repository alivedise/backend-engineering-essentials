...
See [BEE-221](221.md) for a full treatment of delivery guarantees.
...
Configure a DLQ on every durable subscription. Route messages that exceed the retry limit to the DLQ for inspection, alerting, and manual replay. See [BEE-221](221.md).
...
- [BEE-220](220.md) — Message queues vs event streams: when to use each model
- [BEE-221](221.md) — Delivery guarantees: at-most-once, at-least-once, exactly-once
- [BEE-221](221.md) — Dead letter queues and poison message handling
- [BEE-101](101.md) — DDD domain events: what to publish and why
