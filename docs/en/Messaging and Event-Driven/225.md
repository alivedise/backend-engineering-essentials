...
- [BEE-220](220.md) — Messaging fundamentals: broker patterns that backpressure integrates with
- [BEE-260](260.md) — Circuit Breaker: service-level protection that complements backpressure
- [BEE-266](266.md) — Rate Limiting: request-rate control, a static form of backpressure
- [BEE-305](305.md) — Async Processing: patterns where backpressure is structurally required
