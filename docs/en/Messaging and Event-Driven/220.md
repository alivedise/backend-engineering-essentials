...
- [BEE-221](221.md) — Pub/Sub patterns and fan-out
- [BEE-222](222.md) — Delivery guarantees: at-most-once, at-least-once, exactly-once
- [BEE-223](223.md) — Event sourcing: rebuilding state from an event log
- [BEE-143](143.md) — Serialization formats for messages (Avro, Protobuf, JSON)
