...
# [BEP-220] Message Queues vs Event Streams
...
- **BEP-221** — Pub/Sub patterns and fan-out
- **BEP-222** — Delivery guarantees: at-most-once, at-least-once, exactly-once
- **BEP-223** — Event sourcing: rebuilding state from an event log
- **BEP-143** — Serialization formats for messages (Avro, Protobuf, JSON)
