...
- [BEE-30041](llm-self-consistency-and-ensemble-sampling.md) -- LLM Self-Consistency and Ensemble Sampling: samples the same model N times and takes majority vote — no debate or critique; complementary approach to accuracy improvement
- [BEE-30044](llm-planning-and-task-decomposition.md) -- LLM Planning and Task Decomposition: planning separates subtasks; debate and critique improve the quality of individual subtask responses
- [BEE-30020](llm-guardrails-and-content-safety.md) -- LLM Guardrails and Content Safety: Constitutional AI's critique-and-revise is also a guardrail technique when the constitution specifies safety principles
- [BEE-30043](llm-hallucination-detection-and-factual-grounding.md) -- LLM Hallucination Detection and Factual Grounding: multi-agent debate can reduce hallucinations for reasoning tasks, but does not replace faithfulness checking against retrieved context
