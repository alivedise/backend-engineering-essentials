...
- [BEE-30002](ai-agent-architecture-patterns.md) -- AI Agent Architecture Patterns: the agent architectures within which planning and task decomposition operate
- [BEE-30018](llm-tool-use-and-function-calling-patterns.md) -- LLM Tool Use and Function Calling Patterns: the mechanism by which ReAct actions invoke tools
- [BEE-30035](ai-agent-safety-and-reliability-patterns.md) -- AI Agent Safety and Reliability Patterns: agent budget caps and circuit breakers bound how long a planning loop may run
- [BEE-30027](ai-workflow-orchestration.md) -- AI Workflow Orchestration: DAG-based orchestration for deterministic workflows complements LLM-generated dynamic plans
- [BEE-30023](chain-of-thought-and-extended-thinking-patterns.md) -- Chain-of-Thought and Extended Thinking Patterns: chain-of-thought is the per-subtask reasoning; planning is the cross-subtask structure
