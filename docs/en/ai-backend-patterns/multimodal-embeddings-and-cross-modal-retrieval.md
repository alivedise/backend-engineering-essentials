...
- [BEE-30014](embedding-models-and-vector-representations.md) -- Embedding Models and Vector Representations: single-modal embedding fundamentals
- [BEE-30026](vector-database-architecture.md) -- Vector Database Architecture: storing and querying the embedding index
- [BEE-30019](multi-modal-llm-integration-patterns.md) -- Multi-modal LLM Integration Patterns: using multimodal LLMs alongside retrieval
