...
- [BEE-30006](structured-output-and-constrained-decoding.md) -- Structured Output and Constrained Decoding: token-level grammar enforcement mechanisms that underpin the constrained decoding tier described here
- [BEE-30018](llm-tool-use-and-function-calling-patterns.md) -- LLM Tool Use and Function Calling Patterns: Anthropic tool use is the mechanism that provides native hard schema enforcement
- [BEE-30043](llm-hallucination-detection-and-factual-grounding.md) -- LLM Hallucination Detection and Factual Grounding: hallucination detection and structured extraction are complementary; a validated schema does not guarantee factual correctness of extracted values
- [BEE-30035](ai-agent-safety-and-reliability-patterns.md) -- AI Agent Safety and Reliability Patterns: retry budgets and circuit breakers for extraction pipelines follow the same patterns as agent reliability controls
