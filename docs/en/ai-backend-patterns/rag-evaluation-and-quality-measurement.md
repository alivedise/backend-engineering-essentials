...
- [BEE-30007](rag-pipeline-architecture.md) -- RAG Pipeline Architecture: the system architecture that this article evaluates; chunking, embedding, and retrieval strategy all affect these metrics
- [BEE-30029](advanced-rag-and-agentic-retrieval-patterns.md) -- Advanced RAG and Agentic Retrieval Patterns: rerankers, query expansion, and hybrid search improve context recall and precision
- [BEE-30043](llm-hallucination-detection-and-factual-grounding.md) -- LLM Hallucination Detection and Factual Grounding: faithfulness checking is a specialized form of hallucination detection applied to the retrieved context
- [BEE-30049](llm-evaluation-metrics-and-automated-scoring-pipelines.md) -- LLM Evaluation Metrics and Automated Scoring Pipelines: the general evaluation infrastructure within which RAG-specific metrics run
