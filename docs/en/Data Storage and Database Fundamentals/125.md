...
Columns that appear in `WHERE`, `JOIN ON`, and `ORDER BY` clauses are candidates for indexing. See [BEE-121](121.md) for indexing strategy.
...
- [BEE-121](121.md) — Database Indexing Strategies: which columns to index and how
- [BEE-301](301.md) — Resource Management: connection lifecycle and cleanup patterns
- [BEE-303](303.md) — Profiling and Observability: detecting slow queries and N+1 in production
