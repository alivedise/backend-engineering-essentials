...
:::tip Deep Dive
For database-level schema evolution patterns and backward compatibility, see [DDP Schema Evolution series](https://alivedise.github.io/database-design-principles/300).
:::
...
- **[BEP-104] Strangler Fig** — the same incremental, parallel-operation philosophy applied to service decomposition; expand-contract is its database equivalent.
- **[BEP-142] Schema Evolution** — deeper treatment of schema versioning contracts between services.
- **[BEP-361] Deployment Strategies** — rolling deploys, blue-green, and canary patterns that interact with migration sequencing.
