...
# [BEP-122] Replication Strategies
...
- [BEP-120: SQL vs NoSQL](./120.md) — choosing storage engines that constrain replication options
- [BEP-123: Sharding](./123.md) — partitioning data across nodes, often combined with per-shard replication
- [BEP-160: ACID Transactions](./160.md) — how replication interacts with transaction isolation
- [BEP-165: Eventual Consistency](./165.md) — the consistency model that leaderless and async replication naturally provides
