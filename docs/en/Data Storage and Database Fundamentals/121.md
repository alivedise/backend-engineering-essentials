...
:::tip Deep Dive
For database-level indexing internals and storage engine details, see [DDP Indexing and Storage series](https://alivedise.github.io/database-design-principles/145).
:::
...
- [BEP-120 — SQL vs NoSQL](./120.md): Choosing the right database affects what index types are available and relevant.
- [BEP-124 — Storage Engines](./124.md): How the storage engine (InnoDB, WiredTiger, etc.) interacts with indexes at the page level.
- [BEP-125 — Query Optimization](./125.md): EXPLAIN in depth, statistics, and query planner hints.
- [BEP-303 — Profiling](../../Performance and Scalability/303.md): Measuring the actual impact of index changes in production.
