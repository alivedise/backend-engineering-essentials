...
- Vertical scaling has limits; horizontal sharding is possible but adds complexity (see [BEE-12](12.md)3).
...
SQL databases do scale — PostgreSQL handles millions of queries per second with proper indexing, read replicas, and connection pooling. Horizontal sharding is complex but possible (see [BEE-12](12.md)3). Choosing NoSQL to "avoid scaling problems" without benchmarking the actual bottleneck is premature optimization.
...
- [BEE-121](121.md) — Indexing Deep Dive: how indexes work across SQL and NoSQL systems
- [BEE-122](122.md) — Replication Strategies: primary-replica, multi-primary, eventual consistency
- [BEE-123](123.md) — Partitioning and Sharding: horizontal scaling strategies for large datasets
- [BEE-140](140.md) — Data Modeling: translating domain concepts to database structures
