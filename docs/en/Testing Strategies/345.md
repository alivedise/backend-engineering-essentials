...
See also: [BEE-361 — Canary Deployments](/en/Deployment%20Strategies/361) for implementation detail.
...
See also: [BEE-363 — Feature Flags](/en/Deployment%20Strategies/363).
...
- **Use SLOs as gates**: a canary that degrades your SLO error budget should fail automatically. See [BEE-324 — SLOs as Success Criteria](/en/Observability/324).
...
- [BEE-265 — Chaos Engineering](/en/Testing%20Strategies/265): Proactively injecting failures in production to verify resilience.
- [BEE-324 — SLOs as Success Criteria](/en/Observability/324): Using SLO error budgets as automated gates for canary promotion.
- [BEE-361 — Canary Deployments](/en/Deployment%20Strategies/361): Infrastructure patterns for traffic splitting and automated rollback.
- [BEE-363 — Feature Flags](/en/Deployment%20Strategies/363): Decoupling deployment from release for granular rollout control.
