...
Use contract testing to catch shape mismatches early and continuously. Use integration testing to verify that components behave correctly when wired together (see [BEE-34](34.md)1). Use E2E tests for validating full user journeys.
...
- [BEE-71](71.md) (API Versioning) — how to evolve provider APIs without breaking consumers; contract testing makes breaking changes detectable
- [BEE-142](142.md) (Schema Evolution) — strategies for evolving data schemas in a way that preserves backwards compatibility
- [BEE-340](340.md) (The Testing Pyramid) — contract testing's place between integration tests and unit tests
- [BEE-341](341.md) (Integration Testing for Backend Services) — the complementary layer that tests behavior where contract testing tests shape
