...
# [BEP-162] Distributed Transactions and Two-Phase Commit
...
For the order/payment case, the brief inconsistency is acceptable and saga is the standard recommendation. See [BEP-163](./163.md) for saga patterns in detail.
...
- [BEP-160: ACID Properties](./160.md) -- foundation of transaction semantics within a single database
- [BEP-163: Saga Pattern](./163.md) -- compensating transactions as the practical alternative to 2PC
- [BEP-164: Idempotency and Exactly-Once Semantics](./164.md) -- making distributed operations safe to retry
- [BEP-165: Eventual Consistency Patterns](./165.md) -- trading strong consistency for availability
