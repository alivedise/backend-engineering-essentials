...
# [BEP-164] Idempotency and Exactly-Once Semantics
...
- [BEP-72: API Idempotency](../API%20Design/72.md) -- idempotency keys in HTTP API design
- [BEP-163: Saga Pattern](./163.md) -- saga compensating transactions must be idempotent
- [BEP-222: Delivery Guarantees](./222.md) -- at-most-once, at-least-once, exactly-once in messaging systems
- [BEP-226: Idempotent Message Processing](./226.md) -- patterns for idempotent consumers in event-driven systems
