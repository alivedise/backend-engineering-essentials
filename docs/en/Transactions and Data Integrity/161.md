...
# [BEP-161] Isolation Levels and Their Anomalies
...
:::tip Related
For the foundational ACID model, see [BEP-160](./160.md). For distributed transaction coordination, see [BEP-162](./162.md). For concurrency control strategies, see [BEP-245](../Concurrency/245.md).
:::
...
- [BEP-160: ACID Properties](./160.md) -- foundational transaction model
- [BEP-162: Distributed Transactions and Two-Phase Commit](./162.md) -- cross-service coordination
- [BEP-245: Optimistic vs. Pessimistic Concurrency](../Concurrency/245.md) -- choosing a locking strategy
