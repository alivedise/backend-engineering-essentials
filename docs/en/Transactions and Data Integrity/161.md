...
:::tip Related
For the foundational ACID model, see [BEE-160](./160.md). For distributed transaction coordination, see [BEE-162](./162.md). For concurrency control strategies, see [BEE-245](245.md).
:::
