...
:::tip Related
For the foundational ACID model, see [BEE-8001](acid-properties.md). For distributed transaction coordination, see [BEE-8003](distributed-transactions-and-two-phase-commit.md). For concurrency control strategies, see [BEE-11006](../concurrency/optimistic-vs-pessimistic-concurrency-control.md).
:::
