...
- [BEE-10002](publish-subscribe-pattern.md) — Pub/Sub patterns and fan-out
- [BEE-10003](delivery-guarantees.md) — Delivery guarantees: at-most-once, at-least-once, exactly-once
- [BEE-10004](event-sourcing.md) — Event sourcing: rebuilding state from an event log
- [BEE-7004](../data-modeling/encoding-and-serialization-formats.md) — Serialization formats for messages (Avro, Protobuf, JSON)
