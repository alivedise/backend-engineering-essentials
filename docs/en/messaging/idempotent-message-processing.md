...
**Related BEPs:**
- [BEE-4003](../api-design/api-idempotency.md) — API idempotency (same principle applied at the HTTP layer)
- [BEE-8005](../transactions/idempotency-and-exactly-once-semantics.md) — Exactly-once semantics
- [BEE-10003](delivery-guarantees.md) — Delivery guarantees
- [BEE-10005](dead-letter-queues-and-poison-messages.md) — Dead letter queues
