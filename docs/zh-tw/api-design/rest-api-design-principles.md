...
:::tip Deep Dive
關於完整的 API 設計指南，包含命名慣例、錯誤設計與治理規範，請參閱 [ADE (API Design Essentials)](https://alivedise.github.io/api-design-essentials/)。
:::
...
- [BEE-3003](../networking-fundamentals/http-versions.md) HTTP 協定基礎
- [BEE-4002](api-versioning-strategies.md) API 版本控制策略
- [BEE-4003](api-idempotency.md) API 冪等性
- [BEE-4004](pagination-patterns.md) 分頁模式
- [BEE-4006](api-error-handling-and-problem-details.md) API 錯誤處理與 Problem Details
