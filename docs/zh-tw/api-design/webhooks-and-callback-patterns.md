...
Webhook 採用**至少一次交付**語義。發送方持續重試直到收到 2xx 回應或耗盡重試額度。這意味著消費者必須實作冪等性（參見 [BEE-4003](api-idempotency.md)）。
...
若處理超過 10 秒，發送方很可能逾時並重試，造成重複與負載放大。務必將工作卸載至佇列（參見 [BEE-10001](../messaging/message-queues-vs-event-streams.md)）。
...
- [BEE-2005](../security-fundamentals/cryptographic-basics-for-engineers.md) — HMAC 密碼學基礎
- [BEE-4003](api-idempotency.md) — API 中的冪等性
- [BEE-10001](../messaging/message-queues-vs-event-streams.md) — 訊息傳遞模式與非同步處理
- [BEE-12002](../resilience/retry-strategies-and-exponential-backoff.md) — 重試策略與指數退避
