...
- [BEP-52: HTTP 基礎](../../HTTP/52.md) -- 請求/回應模型、狀態碼與標頭
- [BEP-200: 快取基礎與快取層級](./200.md) -- TTL、逐出與一致性概念，是本文的基礎
- [BEP-304: CDN 架構](../../Infrastructure/304.md) -- CDN 節點如何消費並傳播 `Cache-Control` 指令
