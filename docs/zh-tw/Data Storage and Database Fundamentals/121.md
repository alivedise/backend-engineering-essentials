...
:::tip Deep Dive
資料庫層級的索引內部機制與儲存引擎細節，請參閱 [DDP Indexing and Storage series](https://alivedise.github.io/database-design-principles/145)。
:::
...
- [BEE-303 — 效能分析](../../Performance and Scalability/303.md)：在正式環境中測量索引變更的實際影響。
