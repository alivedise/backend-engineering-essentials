...
當結構演進已不足夠而必須進行版本切換時，請參閱 [BEE-4002](../api-design/api-versioning-strategies.md)（API 版本控制）。
...
最佳實踐：
- 所有結構變更必須透過遷移腳本套用（參見 [BEE-6007](../data-storage/database-migrations.md)）。
...
- [BEE-4002](../api-design/api-versioning-strategies.md) — API 版本控制：當結構演進已不足夠而需要進行版本切換時
- [BEE-6007](../data-storage/database-migrations.md) — 資料庫遷移：安全地對持久儲存套用結構變更
- [BEE-7004](encoding-and-serialization-formats.md) — 編碼格式：在 Protobuf、Avro、JSON 和 MessagePack 之間做選擇
