...
- [BEE-10](10.md) -- 身份驗證與授權：在設置租戶上下文之前必須建立租戶身份
- [BEE-13](13.md) -- Session 管理：多租戶系統中的 Session 將租戶身份作為一級聲明攜帶
- [BEE-123](123.md) -- 分區與分片：大規模孤島和橋接模型成為一種租戶鍵控分片形式
- [BEE-161](161.md) -- 隔離級別及其異常：RLS 與事務隔離交互；理解兩個層次
