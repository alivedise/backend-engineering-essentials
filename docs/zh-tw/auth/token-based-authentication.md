...
- [BEE-1001](authentication-vs-authorization.md) Authentication vs Authorization -- 身分識別與權限的概念邊界
- [BEE-1003](oauth-openid-connect.md) OAuth 2.0 and OpenID Connect -- 令牌簽發與委派流程
- [BEE-1004](session-management.md) Session Management -- 伺服器端 session 作為令牌的替代方案
- [BEE-1007](webauthn-fundamentals.md) WebAuthn 基礎 -- WebAuthn 儀式成功後通常發放工作階段令牌
- [BEE-1008](passkeys-discoverable-credentials.md) Passkey：可發現憑證與 UX 模式 -- Passkey 發放的工作階段仍依循本文涵蓋的令牌管理模式
- [BEE-2001](../security-fundamentals/owasp-top-10-for-backend.md) OWASP Top 10 for Backend -- 安全漏洞背景
- [BEE-2005](../security-fundamentals/cryptographic-basics-for-engineers.md) 工程師的密碼學基礎 -- 簽名演算法與金鑰管理基礎
