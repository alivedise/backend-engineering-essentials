...
- [BEE-10: Authentication vs Authorization](10.md) — 身分識別與權限的概念邊界
- [BEE-11: OAuth 2.0 and OpenID Connect](11.md) — 令牌簽發與委派流程
- [BEE-13: Session Management](13.md) — 伺服器端 session 作為令牌的替代方案
- [BEE-30: OWASP Top 10 Mapping](30.md) — 安全漏洞背景
- [BEE-31: Cryptographic Primitives](31.md) — 簽名演算法與金鑰管理基礎
