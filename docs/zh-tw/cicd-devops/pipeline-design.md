...
- [BEE-15001](../testing/testing-pyramid.md) — 測試策略；哪些測試類型屬於哪個管線階段
- [BEE-16001](continuous-integration-principles.md) — CI 原則；使管線設計有效運作的上游實踐
- [BEE-16002](deployment-strategies.md) — 部署策略；管線晉升產出物後的後續步驟
- [BEE-16005](container-fundamentals.md) — 容器即產出物；映像檔的建置、標記與儲存方式
