...
**相關 BEP：**
- [BEP-240 程序](/zh-tw/OS%20and%20Linux%20Fundamentals/240) -- 容器本質上是程序
- [BEP-325 健康檢查](/zh-tw/CI%20CD%20and%20DevOps/325) -- 容器內的健康檢查
- [BEP-361 部署策略](/zh-tw/CI%20CD%20and%20DevOps/361) -- 容器作為部署單位
