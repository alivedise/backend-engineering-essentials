...
- [BEE-33](33.md) -- CORS 與同源策略：控制跨域資料讀取的機制；安全標頭控制內容本身的瀏覽器行為
- [BEE-34](34.md) -- 工程師的密碼學基礎：SHA-256 雜湊計算是基於雜湊的 CSP 的基礎；nonce 生成背後的密碼學
- [BEE-482](../Security/482.md) -- 零信任安全架構：安全標頭是零信任模型的瀏覽器端執行層
- [BEE-488](488.md) -- OWASP API 安全 Top 10：安全標頭解決了多項 API 安全風險，包括資訊洩漏和透過 XSS 的注入
