...
- [BEE-2001: OWASP Top 10 for Backend](30.md) — A06 Vulnerable and Outdated Components 在完整 Top 10 脈絡中的介紹
- [BEE-2002: Secrets Management](31.md) — 透過受入侵依賴洩露的憑證
- [BEE-16006: Pipeline Design](365.md) — CI/CD pipeline 安全控制與成品簽署
