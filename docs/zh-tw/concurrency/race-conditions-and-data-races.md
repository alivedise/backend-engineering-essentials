...
這是關聯式資料庫中儲存金融或庫存狀態的正確做法。參見 [BEE-8002](../transactions/isolation-levels-and-their-anomalies.md) 了解隔離層級，[BEE-11006](optimistic-vs-pessimistic-concurrency-control.md) 了解樂觀與悲觀並發控制策略。
...
- [BEE-11002](race-conditions-and-data-races.md) -- 鎖與同步原語
- [BEE-11006](optimistic-vs-pessimistic-concurrency-control.md) -- 樂觀與悲觀並發控制
- [BEE-8002](../transactions/isolation-levels-and-their-anomalies.md) -- 隔離層級：資料庫如何在儲存層防止競態條件
