...
請參閱 [BEE-225](../Resilience and Reliability/225.md) 了解背壓模式。
...
- [BEE-220](../Messaging and Event-Driven/220.md) — 訊息傳遞與事件驅動架構
- [BEE-221](../Messaging and Event-Driven/221.md) — 死信佇列
- [BEE-225](../Resilience and Reliability/225.md) — 背壓模式
- [BEE-241](../Concurrency and Async/241.md) — 工作者池
