...
5. **新增或修正索引** — 索引策略詳見 [BEE-121](121.md)。
...
基於百分位目標的 SLO 定義，詳見 [BEE-321](321.md)。
...
- [BEE-121](121.md) — 查詢優化的索引策略
- [BEE-125](125.md) — 查詢優化原則
- [BEE-320](320.md) — 可觀測性指標設計
- [BEE-321](321.md) — SLO 定義與百分位目標
