...
:::tip 相關文章
ACID 基礎模型請見 [BEP-160](./160.md)。分散式交易協調請見 [BEP-162](./162.md)。並行控制策略請見 [BEP-245](../Concurrency/245.md)。
:::
...
- [BEP-160: ACID Properties](./160.md) -- 基礎交易模型
- [BEP-162: Distributed Transactions and Two-Phase Commit](./162.md) -- 跨服務協調
- [BEP-245: Optimistic vs. Pessimistic Concurrency](../Concurrency/245.md) -- 選擇鎖定策略
