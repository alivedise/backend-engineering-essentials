...
- [BEP-72: API 冪等性](../API%20Design/72.md) -- HTTP API 設計中的冪等性金鑰
- [BEP-163: Saga 模式](./163.md) -- Saga 補償交易必須具有冪等性
- [BEP-222: 傳遞保證](./222.md) -- 訊息系統中的至多一次、至少一次、恰好一次
- [BEP-226: 冪等訊息處理](./226.md) -- 事件驅動系統中冪等消費者的模式
