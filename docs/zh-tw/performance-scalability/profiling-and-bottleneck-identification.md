...
5. **新增或修正索引** — 索引策略詳見 [BEE-6002](../data-storage/indexing-deep-dive.md)。
...
基於百分位目標的 SLO 定義，詳見 [BEE-14002](../observability/structured-logging.md)。
...
- [BEE-6002](../data-storage/indexing-deep-dive.md) — 查詢優化的索引策略
- [BEE-6006](../data-storage/connection-pooling-and-query-optimization.md) — 查詢優化原則
- [BEE-14001](../observability/three-pillars-logs-metrics-traces.md) — 可觀測性指標設計
- [BEE-14002](../observability/structured-logging.md) — SLO 定義與百分位目標
