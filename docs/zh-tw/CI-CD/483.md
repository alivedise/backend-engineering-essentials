...
- [BEE-362](../CI-CD/362.md) -- 基礎設施即程式碼：平台的自助服務基礎設施層建立在 IaC 上；平台通過更高層次的自助服務介面公開 IaC
- [BEE-361](../CI-CD/361.md) -- 部署策略：黃金路徑編碼了組織首選的部署策略（金絲雀、藍綠）；平台自動化執行
- [BEE-363](../CI-CD/363.md) -- 功能旗標：功能旗標管理通常是平台能力，為團隊提供自助服務方式來建立和管理旗標
- [BEE-32](../Security/32.md) -- 秘密管理：秘密管理是核心平台能力；平台提供自助服務秘密建立，抽象了底層的秘密存儲
