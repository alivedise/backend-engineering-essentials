...
- [BEE-8001: ACID 屬性](./160.md) -- 單一資料庫內交易語義的基礎
- [BEE-8004: Saga 模式](./163.md) -- 作為 2PC 實際替代方案的補償交易
- [BEE-8005: 冪等性與恰好一次語義](./164.md) -- 使分散式操作安全重試
- [BEE-8006: 最終一致性模式](./165.md) -- 以強一致性換取可用性
