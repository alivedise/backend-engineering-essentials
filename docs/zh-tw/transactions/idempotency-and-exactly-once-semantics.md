...
- [BEE-4003: API 冪等性](../api-design/api-idempotency.md) -- HTTP API 設計中的冪等性金鑰
- [BEE-8004: Saga 模式](saga-pattern.md) -- Saga 補償交易必須具有冪等性
- [BEE-10003: 傳遞保證](../messaging/delivery-guarantees.md) -- 訊息系統中的至多一次、至少一次、恰好一次
- [BEE-10007: 冪等訊息處理](../messaging/idempotent-message-processing.md) -- 事件驅動系統中冪等消費者的模式
