...
:::tip 相關文章
ACID 基礎模型請見 [BEE-8001](acid-properties.md)。分散式交易協調請見 [BEE-8003](distributed-transactions-and-two-phase-commit.md)。並行控制策略請見 [BEE-11006](../concurrency/optimistic-vs-pessimistic-concurrency-control.md)。
:::
...
- [BEE-8001: ACID Properties](acid-properties.md) -- 基礎交易模型
- [BEE-8003: Distributed Transactions and Two-Phase Commit](distributed-transactions-and-two-phase-commit.md) -- 跨服務協調
- [BEE-11006: Optimistic vs. Pessimistic Concurrency](../concurrency/optimistic-vs-pessimistic-concurrency-control.md) -- 選擇鎖定策略
