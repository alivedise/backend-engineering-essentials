...
- [BEP-10: Authentication vs Authorization](/zh-tw/Authentication%20and%20Authorization/10) — 身分識別與權限的概念邊界
- [BEP-11: OAuth 2.0 and OpenID Connect](/zh-tw/Authentication%20and%20Authorization/11) — 令牌簽發與委派流程
- [BEP-13: Session Management](/zh-tw/Authentication%20and%20Authorization/13) — 伺服器端 session 作為令牌的替代方案
- [BEP-30: OWASP Top 10 Mapping](/zh-tw/Security%20Fundamentals/30) — 安全漏洞背景
- [BEP-31: Cryptographic Primitives](/zh-tw/Security%20Fundamentals/31) — 簽名演算法與金鑰管理基礎
