...
OAuth 2.0 是授權委派框架。Access token 只證明資源擁有者委派了某些 scope——並不向你的應用程式認證使用者身份。當你需要驗證使用者身份時，請在 OAuth 2.0 之上使用 OpenID Connect（OIDC）。（參見 BEE-12。）
...
- [BEE-11: Token-Based Authentication](/zh-tw/Authentication%20and%20Authorization/11) — token 如何建立身份
- [BEE-12: OAuth 2.0 and OpenID Connect](/zh-tw/Authentication%20and%20Authorization/12) — 委派 vs. 認證
- [BEE-13: Session Management](/zh-tw/Authentication%20and%20Authorization/13) — 維持已認證的狀態
- [BEE-14: RBAC vs ABAC](/zh-tw/Authentication%20and%20Authorization/14) — 深入探討權限模型
- [BEE-15: API Key Management](/zh-tw/Authentication%20and%20Authorization/15) — API 憑證模式
