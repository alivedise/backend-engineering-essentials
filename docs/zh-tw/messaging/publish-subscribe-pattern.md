...
詳見 [BEE-10002](publish-subscribe-pattern.md) 的完整遞送保證說明。
...
在每個持久性訂閱上配置 DLQ。將超過重試上限的訊息路由至 DLQ，以便檢查、告警和手動重播。詳見 [BEE-10002](publish-subscribe-pattern.md)。
...
- [BEE-10001](message-queues-vs-event-streams.md) — 訊息佇列 vs 事件串流：何時選用各模型
- [BEE-10002](publish-subscribe-pattern.md) — 遞送保證：至多一次、至少一次、恰好一次
- [BEE-10002](publish-subscribe-pattern.md) — 死信佇列與毒訊息處理
- [BEE-5002](../architecture-patterns/domain-driven-design-essentials.md) — DDD 領域事件：要發布什麼以及原因
