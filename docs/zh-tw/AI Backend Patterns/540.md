...
- [BEE-506](506.md) -- 評估與測試 LLM 應用：把關部署的離線黃金資料集評估
- [BEE-511](511.md) -- LLM 可觀測性與監控：餵入飛輪的軌跡收集和指標基礎設施
- [BEE-514](514.md) -- 微調與 PEFT 模式：飛輪驅動的 SFT 和 LoRA 機制
- [BEE-524](524.md) -- 人機協作 AI 模式：標記選定軌跡的人工審查佇列
- [BEE-530](530.md) -- 提示詞管理與版本控制：作為快速路徑改善動作的提示詞更新
- [BEE-534](534.md) -- AI 系統的合成資料生成：可驗證領域的合成偏好對
- [BEE-536](536.md) -- AI 實驗與模型 A/B 測試：用於改善部署的影子模式和金絲雀遞增
