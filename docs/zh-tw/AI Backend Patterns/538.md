...
- [BEE-536](536.md) -- AI 實驗與模型 A/B 測試：模型遷移重用的金絲雀發佈與穩定使用者分配模式
- [BEE-530](530.md) -- 提示詞管理與版本控制：需要重新工程時，與模型 ID 一同進行提示詞版本管理
- [BEE-506](506.md) -- 評估與測試 LLM 應用：回歸套件所基於的黃金資料集評估方法
- [BEE-513](513.md) -- AI 成本最佳化與模型路由：跨模型按成本和能力路由的備用鏈模式
