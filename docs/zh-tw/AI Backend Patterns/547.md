...
- [BEE-543](543.md) -- LLM 自我一致性與集成採樣：對同一模型採樣 N 次並取多數投票——無辯論或批評；是提升準確率的互補方法
- [BEE-546](546.md) -- LLM 規劃與任務分解：規劃負責拆分子任務；辯論與批評改善個別子任務的回應品質
- [BEE-522](522.md) -- LLM 護欄與內容安全：憲法 AI 的批判與修改也是一種護欄技術，當憲法規定安全原則時尤為如此
- [BEE-545](545.md) -- LLM 幻覺偵測與事實接地：多智能體辯論可降低推理任務的幻覺，但不能取代針對檢索上下文的忠實度檢查
