...
- [BEE-504](504.md) -- AI 代理架構模式：BEE-504 確立了高風險代理動作的人工檢查點原則；BEE-524 提供這些檢查點背後的佇列和工作流實現
- [BEE-506](506.md) -- 評估和測試 LLM 應用：稽核採樣和覆蓋率追蹤是饋入 BEE-506 中描述的持續評估迴路的評估信號
- [BEE-519](519.md) -- 長運行代理的 AI 記憶體系統：人工更正的輸出是一種情節記憶，可以存儲和檢索以改進未來的回應
- [BEE-522](522.md) -- LLM 護欄與內容安全：安全違規是饋入 HITL 佇列的主要升級觸發器之一
