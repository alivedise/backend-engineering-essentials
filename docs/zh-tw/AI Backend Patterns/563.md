...
- [BEE-523](523.md) -- LLM 推論優化與自托管：量化所屬的更廣泛優化領域
- [BEE-561](561.md) -- LLM 推論的投機解碼：與量化隱藏狀態交互；量化後需驗證接受率
- [BEE-562](562.md) -- Multi-LoRA 服務與適配器管理：FP16 訓練的 LoRA 適配器必須反量化以匹配適配器原始精度；vLLM 自動處理此問題
