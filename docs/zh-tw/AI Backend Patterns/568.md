...
- [BEE-523](523.md) -- LLM 推論優化與自主託管：硬體選型與整體推論優化
- [BEE-566](566.md) -- 混合專家架構與服務：Expert Parallel 與 TP/PP 排程的交互
- [BEE-567](567.md) -- 連續批次處理與迭代層級排程：PP 的微批次與連續批次排程器的交互
- [BEE-563](563.md) -- LLM 推論量化：量化降低每張 GPU 的記憶體需求，從而改變所需的 TP 度數
