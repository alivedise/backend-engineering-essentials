...
- [BEE-506](506.md) -- LLM 應用的評估與測試：LLM 測試策略的基礎框架；本文專注於指標和 CI/CD 管道架構
- [BEE-552](552.md) -- RAG 評估與品質測量：針對 RAG 特定管道，將評估分解為檢索與生成組件
- [BEE-536](536.md) -- AI 實驗與模型 A/B 測試：生產環境中的受控實驗，驗證評估改進是否轉化為用戶效果
