...
- **版本化你的錯誤契約** — 更改錯誤碼、錯誤本文或問題詳情（Problem Details，見 BEP-75）的結構是破壞性變更。
...
- [BEP-71](71.md) API 的冪等性
- [BEP-75](75.md) API 錯誤處理與問題詳情
- [BEP-141](../Data Modeling and Storage/141.md) Schema 演進
