...
:::tip Deep Dive
關於完整的 API 版本治理與生命週期管理，請參閱 [ADP (API Design Principles)](https://alivedise.github.io/api-design-principle-beta/)。
:::
...
- **版本化你的錯誤契約** — 更改錯誤碼、錯誤本文或問題詳情（Problem Details，見 BEE-75）的結構是破壞性變更。
...
- [BEE-71](71.md) API 的冪等性
- [BEE-75](75.md) API 錯誤處理與問題詳情
- [BEE-141](../Data Modeling and Storage/141.md) Schema 演進
