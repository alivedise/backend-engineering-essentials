...
Webhook 採用**至少一次交付**語義。發送方持續重試直到收到 2xx 回應或耗盡重試額度。這意味著消費者必須實作冪等性（參見 [BEP-72](/zh-tw/API%20Design%20and%20Communication%20Protocols/72)）。
...
若處理超過 10 秒，發送方很可能逾時並重試，造成重複與負載放大。務必將工作卸載至佇列（參見 [BEP-220](/zh-tw/API%20Design%20and%20Communication%20Protocols/220)）。
...
- [BEP-34](/zh-tw/Security%20and%20Resilience/34) — HMAC 密碼學基礎
- [BEP-72](/zh-tw/API%20Design%20and%20Communication%20Protocols/72) — API 中的冪等性
- [BEP-220](/zh-tw/API%20Design%20and%20Communication%20Protocols/220) — 訊息傳遞模式與非同步處理
- [BEP-261](/zh-tw/Reliability%20and%20Operations/261) — 重試策略與指數退避
