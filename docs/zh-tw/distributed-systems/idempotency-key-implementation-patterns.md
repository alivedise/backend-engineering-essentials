...
- [BEE-4003](../api-design/api-idempotency.md) -- API 中的冪等性：涵蓋哪些 HTTP 方法在協議上是冪等的，以及為何設計冪等 API 很重要；本文涵蓋伺服器端實作機制
- [BEE-8005](../transactions/idempotency-and-exactly-once-semantics.md) -- 冪等性與精確一次語義：涵蓋訊息處理層的冪等性；冪等鍵模式是 API 層的等效機制
- [BEE-12002](../resilience/retry-strategies-and-exponential-backoff.md) -- 重試策略與指數退避：冪等鍵使客戶端能夠安全重試；重試策略決定何時以及多頻繁地重試
