...
- [BEE-12003](../resilience/timeouts-and-deadlines.md) -- 逾時與截止時間：優雅關閉中的排空截止時間是截止時間的一個特例——沒有它，一個長期連線可以無限期阻塞關閉
- [BEE-14006](../observability/health-checks-and-readiness-probes.md) -- 健康檢查與就緒探針：就緒探針是關閉期間發出「我未準備好接受流量」訊號的主要機制——必須在排空開始之前設定為失敗
- [BEE-16002](../cicd-devops/deployment-strategies.md) -- 部署策略：滾動更新依賴優雅關閉來實現零停機時間部署；沒有它，被替換的 pod 會丟棄連線
- [BEE-19032](tail-latency-and-hedged-requests.md) -- 尾延遲與對沖請求：排空截止時間太短而關閉緩慢的 pod，可能在部署期間表現為 P99 尖峰——正確的排空大小設定可以防止這種情況
