...
- [BEE-588 生產環境中的模型可解釋性](588) — SHAP 歸因分數通過解釋個別決策來補充公平性指標
- [BEE-587 ML 資料驗證與管道品質閘控](587) — 資料驗證強制執行模式和完整性；公平性審計將其擴展到分佈屬性
- [BEE-586 ML 實驗追蹤與模型登錄庫](586) — 模型卡附加到 MLflow 運行和模型版本
- [BEE-581 AI 合規與治理工程](581) — 模型卡所服務的更廣泛 AI 治理框架
