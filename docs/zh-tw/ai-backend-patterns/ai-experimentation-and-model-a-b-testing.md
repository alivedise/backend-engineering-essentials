...
- [BEE-30004](evaluating-and-testing-llm-applications.md) -- 評估和測試 LLM 應用：饋入影子部署比較階段的離線黃金資料集評估
- [BEE-16004](../cicd-devops/feature-flags.md) -- 功能標誌：將使用者路由到對照組與挑戰者的流量分割和使用者分配基礎設施
- [BEE-30009](llm-observability-and-monitoring.md) -- LLM 可觀察性與監控：在金絲雀漸進期間顯示重試率、延遲和成本的指標收集層
- [BEE-30028](prompt-management-and-versioning.md) -- 提示詞管理與版本控制：提示詞金絲雀推出遵循此處描述的相同漸進模式
