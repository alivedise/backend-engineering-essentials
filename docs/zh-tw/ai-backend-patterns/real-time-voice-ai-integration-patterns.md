...
- [BEE-30016](llm-streaming-patterns.md) -- LLM 串流模式：LLM 到 TTS 流水線化中使用的逐 token 串流模式在此涵蓋
- [BEE-30031](conversational-ai-and-multi-turn-dialog-architecture.md) -- 對話式 AI 與多輪對話架構：輪次管理、上下文窗口處理和對話狀態直接適用於語音流水線
- [BEE-30010](llm-context-window-management.md) -- LLM 上下文窗口管理：語音對話快速積累上下文；需要修剪策略以防止長時間通話中的上下文耗盡
- [BEE-30011](ai-cost-optimization-and-model-routing.md) -- AI 成本最佳化與模型路由：級聯架構與端到端語音架構之間的成本差異是此處涵蓋的路由決策
