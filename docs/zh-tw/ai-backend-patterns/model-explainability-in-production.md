...
- [BEE-585 ML 監控與漂移偵測](585) — 群體級別的漂移監控與逐預測解釋漂移互補
- [BEE-584 ML 模型的影子模式與金絲雀部署](584) — 冠軍/挑戰者比較應包含解釋比較
- [BEE-586 ML 實驗追蹤與模型登錄庫](586) — 通過 `mlflow.log_artifact()` 將解釋製品連結到 MLflow 運行
- [BEE-506 評估和測試 LLM 應用程式](506) — LLM 特定評估模式，與傳統 ML 可解釋性不同
