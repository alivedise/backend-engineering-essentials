...
這是關聯式資料庫中儲存金融或庫存狀態的正確做法。參見 [BEE-161](../Transactions%20and%20Isolation/161.md) 了解隔離層級，[BEE-245](245.md) 了解樂觀與悲觀並發控制策略。
...
- [BEE-240](240.md) -- 並發模型：執行緒、goroutine、async/await
- [BEE-241](241.md) -- 鎖與同步原語
- [BEE-245](245.md) -- 樂觀與悲觀並發控制
- [BEE-161](../Transactions%20and%20Isolation/161.md) -- 隔離層級：資料庫如何在儲存層防止競態條件
