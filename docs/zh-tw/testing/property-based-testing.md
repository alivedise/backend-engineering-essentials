...
- [BEE-15001](testing-pyramid.md) -- 測試金字塔：PBT 的適用位置——它補充基礎的單元測試；不能取代整合或契約測試
- [BEE-15002](integration-testing-for-backend-services.md) -- 後端服務整合測試：PBT 可透過生成真實的請求序列來驅動有狀態 API 的整合測試
- [BEE-15003](contract-testing.md) -- 契約測試：PBT 和契約測試都驗證介面不變量；契約測試固定架構，PBT 在其中生成輸入
- [BEE-15005](test-doubles-mocks-stubs-fakes.md) -- 測試替身：Mocks、Stubs、Fakes：在有狀態 PBT 中，模型扮演真實系統的記憶體 fake
