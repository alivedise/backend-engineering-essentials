...
另見：[BEE-16002 — 金絲雀部署](361.md)，了解實作細節。
...
- **使用 SLO 作為閘道**：降低 SLO 錯誤預算的金絲雀應自動判定失敗。見 [BEE-14005 — 以 SLO 作為成功標準](324.md)。
...
- [BEE-12006 — 混沌工程](265.md)：在生產環境中主動注入故障以驗證韌性。
- [BEE-14005 — 以 SLO 作為成功標準](324.md)：使用 SLO 錯誤預算作為金絲雀晉升的自動閘道。
- [BEE-16002 — 金絲雀部署](361.md)：流量分割和自動回滾的基礎設施模式。
- [BEE-16004 — 功能旗標](363.md)：將部署與發布解耦，實現精細的逐步推出控制。
