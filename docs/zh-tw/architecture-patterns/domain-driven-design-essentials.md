...
本文主要聚焦於策略性 DDD，它直接影響模組與服務邊界的劃定方式（見 [BEE-5001](monolith-vs-microservices-vs-modular-monolith.md)）。
...
- [BEE-5001](monolith-vs-microservices-vs-modular-monolith.md) -- Architecture Patterns：限界上下文直接影響在單體或微服務架構中如何劃定模組與服務邊界
- [BEE-5003](cqrs.md) -- CQRS：DDD 的天然搭檔；領域事件在 CQRS 中用於驅動讀取模型
- [BEE-7001](../data-modeling/entity-relationship-modeling.md) -- Data Modeling：限界上下文所有權如何對應到資料庫 Schema 設計
