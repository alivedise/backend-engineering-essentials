...
當某個特定模組需要獨立擴展、團隊自主性或技術異質性時，它就是抽取的候選對象。使用 Strangler Fig 模式（見 [BEE-5005](strangler-fig-pattern.md)）逐步抽取模組：
...
- [BEE-5002](domain-driven-design-essentials.md) -- Domain-Driven Design Essentials：使用限界上下文識別模組與服務邊界
- [BEE-5005](strangler-fig-pattern.md) -- Strangler Fig Pattern：從單體到服務的漸進式遷移
- [BEE-5006](sidecar-and-service-mesh-concepts.md) -- Sidecar and Service Mesh Concepts：微服務通訊的基礎設施
